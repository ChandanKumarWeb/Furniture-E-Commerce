...
function BlogLftCont(props) {
  ...
  const Calender = (
    ...
    >
      <path
        d="M0.666992 14.8333C0.666992 16.25 1.75033 17.3333 3.16699 17.3333H14.8337C16.2503 17.3333 17.3337 16.25 17.3337 14.8333V8.16663H0.666992V14.8333ZM14.8337 2.33329H13.167V1.49996C13.167 0.999959 12.8337 0.666626 12.3337 0.666626C11.8337 0.666626 11.5003 0.999959 11.5003 1.49996V2.33329H6.50033V1.49996C6.50033 0.999959 6.16699 0.666626 5.66699 0.666626C5.16699 0.666626 4.83366 0.999959 4.83366 1.49996V2.33329H3.16699C1.75033 2.33329 0.666992 3.41663 0.666992 4.83329V6.49996H17.3337V4.83329C17.3337 3.41663 16.2503 2.33329 14.8337 2.33329Z"
        fill="#9F9F9F"
      />
    </svg>
  );
  ...
  return (
    <div>
      <div className="mb-4">
        <img className="w-full h-96" src={props.Img} alt="blogimg" />
        <div className="flex gap-4 my-4">
          <div className="flex gap-2 BlogUplDetail">
            <p>{Profile}</p>
            <p>Admin</p>
          </div>
          <div className="flex gap-2 BlogUplDetail">
